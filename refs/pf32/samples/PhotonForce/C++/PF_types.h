/*! \file
*  \brief Header file defining types and constants used in the Photon Force C API for the PF32.
*/
#pragma once
...
const int MAX_LOG_LEVEL = LOGLEVEL_OFF;
...
typedef enum
{
   ...
   VIO_DAC = 4,                                  //!< Cooled camera
   VTDC_OR_SYNC_THRESHOLD_MV_DAC = 5             //!< Cooled camera or USBC_V2
} PF32_DAC_type;


const unsigned int MAX_SERIAL_NUMBER_LENGTH = 32;
const unsigned int MAX_MODEL_NUMBER_LENGTH = 32;
const unsigned int NO_OF_BYTES_PER_FOOTER = 16;
const int LOWEST_OK_ERROR_CODE = -20;

// Duplicated in PF32_CORRELATOR_API.h as:
// NO_OF_BYTES_CORRELATOR_FOOTER
// NO_OF_BYTES_CORRELATOR_INTENSITY_MAP
